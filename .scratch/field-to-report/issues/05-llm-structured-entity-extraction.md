...
- [x] LLM extraction pipeline using OpenRouter or NVIDIA NIM (e.g. Claude 3.5 Sonnet / Llama 3.3 70B / GPT-4o) with structured JSON schema outputs.
- [x] Schema variation by Project Mode:
...
- [x] Field-level confidence estimation calculating acoustic and semantic certainty.
- [x] Stations with confidence < 0.70 or numeric orientation anomalies automatically tagged with status `FLAGGED_LOW_CONFIDENCE`.
